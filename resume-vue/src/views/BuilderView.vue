...
onMounted(() => {
  if (route.query.template) {
    const map = ['modern', 'classic', 'professional', 'creative', 'minimal', 'academic']
  ...
  <div class="builder-page">
    ...
    <div id="app-container" class="app-container-grid">
      ...
      <main id="preview-panel">
        ...
        >
          <template
            v-if="['modern', 'classic', 'minimal', 'creative'].includes(resumeData.template)"
          >
            <div class="preview-sidebar" v-if="resumeData.template === 'creative'">
              ...
              <header class="preview-header">
                ...
                <div class="contact-info">
                  <p v-if="resumeData.email">邮箱：{{ resumeData.email }}</p>
                  <p v-if="resumeData.phone">电话：{{ resumeData.phone }}</p>
                  <p v-if="resumeData.hometown">籍贯：{{ resumeData.hometown }}</p>
                  <p v-if="resumeData.birthday">生日：{{ resumeData.birthday }}</p>
                </div>
              </header>
            ...
            <div :class="resumeData.template === 'creative' ? 'preview-main' : ''">
              <header class="preview-header" v-if="resumeData.template !== 'creative'">
                <div class="header-content">
                  <div class="name-contact-section">
                    ...
                    <div class="contact-info">
                      ...
                      <span v-if="resumeData.phone">电话：{{ resumeData.phone }}</span>
                      <span v-else>电话</span>

                      <span v-if="resumeData.birthday">生日：{{ resumeData.birthday }}</span>
                      <span v-else>生日</span>

                      <span v-if="resumeData.hometown">籍贯：{{ resumeData.hometown }}</span>
                      <span v-else>籍贯</span>
                    </div>
                  </div>
                  <div class="avatar-container" v-if="resumeData.avatar">
